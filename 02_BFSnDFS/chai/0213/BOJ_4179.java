...
public class BOJ_4179 {
	public static void main(String[] args) throws IOException {
		...
		// 이후 지훈이의 탈출지도를 만든다.
		// 이때 지훈이가 해당 지점에 불보다 늦게 도착한다면 해당 위치에는 갈 수 없다.
		...
		boolean[][] map = new boolean[R+2][C+2]; // 초기 지도
		int[][] fire = new int[R+2][C+2];
		int[][] exit = new int[R+2][C+2];
		int[] jh = new int[2];
